          ...
          <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
              ...
              <div class="relative ml-3">
                ...
                <div x-show=isOpen x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform"
    ...
    <main>
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div class="flex mt-3">
          @for ($i = 1; $i <= 10; $i++)
            @if ($i % 2 == 0)
              <div class="w-8 h-8 bg-teal-500 text-white p-0 me-1 text-xs grid place-items-center rounded-md">
                {{ $i }}
              </div>
            @endif
          @endfor
